...
<body class="bg-gradient-login" style="background-image: url('img/logo/loral1.jpe00g'); background-size: cover;">
    <!-- Login Content -->
                            ...
                            <div class="col-lg-12">
                                <div class="login-form">
                                    ...
                                    <div class="text-center">
                                        <img src="img/logo/logo.png" style="max-width: 100%; height: auto;">
                                        <br><br>
